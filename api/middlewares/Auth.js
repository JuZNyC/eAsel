...
//          .then(user => {
//              if(!user){
//                  return done(null, false, { message: "Failed Login, User DNE" })
//              }
//              if(passwordsMatch(password, user.passwordHash) === false){
//                 return done(null, false, { message: "Failed Login, Password dont match" })
//              }
...
function passwordsMatch(submittedPassword, storedPasswordHash) {
    console.log(submittedPassword, "  :  ", storedPasswordHash)
